...
public class MyRect {
    ...
    public MyRect(MyRect from) {
        this(from.pos.x, from.pos.y, from.getHalfWidth(), from.getHalfHeight());
    }

    public MyRect(float x, float y, float halfWidth, float halfHeight) {
        pos.set(x, y);
    ...
    public boolean isOutside(MyRect other) {
